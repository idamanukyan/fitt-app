...
// ============================================================================
// COACH CLIENTS DATA (for demo coach dashboard)
// ============================================================================
export const mockClients = [
  {
    ...
    is_active: true,
    assigned_at: '2024-08-15T10:30:00Z',
    profile: {
      id: 101,
      user_id: 1,
      full_name: 'Mike Thompson',
      bio: 'Training for my first marathon. Former college basketball player.',
      ...
      goals: 'Run a sub-4 hour marathon, maintain muscle mass',
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-06-01T14:00:00Z',
    profile: {
      id: 102,
      user_id: 2,
      full_name: 'Sarah Chen',
      bio: 'Powerlifter competing in the 57kg class. Aiming for nationals.',
      ...
      goals: 'Qualify for national powerlifting championship',
  ...
  {
    id: 3,
    username: 'james_beginner',
    email: 'james.wilson@email.com',
    is_active: true,
    assigned_at: '2024-11-10T09:00:00Z',
    profile: {
      id: 103,
      user_id: 3,
      full_name: 'James Wilson',
      bio: 'Just started my fitness journey. Looking to lose 20kg.',
      ...
      goals: 'Lose weight, build healthy habits, improve energy levels',
      ...
      updated_at: '2024-12-19T20:00:00Z',
    },
    progress: 45,
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-09-20T11:30:00Z',
    profile: {
      id: 104,
      user_id: 4,
      full_name: 'Emma Rodriguez',
      bio: 'Yoga instructor looking to add strength training to my routine.',
      ...
      fitness_level: 'intermediate' as const,
      activity_level: 'active' as const,
      goals: 'Build lean muscle, improve flexibility, prevent injury',
      preferred_workout_time: 'morning',
      ...
      updated_at: '2024-12-22T07:15:00Z',
    },
    progress: 68,
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-07-05T16:00:00Z',
    profile: {
      id: 105,
      user_id: 5,
      full_name: 'David Nguyen',
      bio: 'Hardgainer trying to put on mass. 3 years of lifting experience.',
      ...
      fitness_level: 'intermediate' as const,
      activity_level: 'active' as const,
      goals: 'Gain 8kg of muscle mass, increase all lifts by 20%',
      preferred_workout_time: 'afternoon',
      workout_days_per_week: 5,
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-10-01T08:00:00Z',
    profile: {
      id: 106,
      user_id: 6,
      full_name: 'Lisa Parker',
      bio: 'Busy mom of 3 trying to get back in shape after pregnancy.',
      ...
      goals: 'Lose baby weight, tone up, have more energy for kids',
      preferred_workout_time: 'morning',
      workout_days_per_week: 3,
      ...
      updated_at: '2024-12-20T06:30:00Z',
    },
    progress: 55,
  ...
  {
    id: 7,
    username: 'alex_comeback',
    email: 'alex.martinez@email.com',
    is_active: false,
    assigned_at: '2024-05-15T12:00:00Z',
    profile: {
      id: 107,
      user_id: 7,
      full_name: 'Alex Martinez',
      bio: 'Former athlete recovering from ACL surgery. Taking it slow.',
      ...
      fitness_level: 'intermediate' as const,
      activity_level: 'light' as const,
      goals: 'Full recovery, regain strength, return to sports',
      preferred_workout_time: 'afternoon',
      workout_days_per_week: 4,
  ...
  },
  {
    ...
    profile: {
      id: 108,
      user_id: 8,
      full_name: 'Nina Kovač',
      bio: 'Bikini competitor. Prepping for my 4th competition.',
      ...
      fitness_level: 'advanced' as const,
      activity_level: 'very_active' as const,
      goals: 'Win regional bikini competition, improve posing',
      preferred_workout_time: 'morning',
      workout_days_per_week: 6,
      ...
      updated_at: '2024-12-22T05:45:00Z',
    },
    progress: 88,
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-08-20T15:00:00Z',
    profile: {
      id: 109,
      user_id: 9,
      full_name: 'Tom Henderson',
      bio: 'Retired executive, 58 years old. Want to stay healthy and active.',
      ...
      goals: 'Maintain mobility, prevent age-related muscle loss, improve golf game',
      preferred_workout_time: 'morning',
      workout_days_per_week: 3,
  ...
  {
    id: 10,
    username: 'kelly_crossfit',
    email: 'kelly.oconnor@email.com',
    is_active: true,
    assigned_at: '2024-03-10T13:00:00Z',
    profile: {
      id: 110,
      user_id: 10,
      full_name: 'Kelly O\'Connor',
      bio: 'CrossFit enthusiast for 2 years. Looking to improve Olympic lifts.',
      ...
      fitness_level: 'advanced' as const,
      activity_level: 'very_active' as const,
      goals: 'Clean 80kg, Snatch 60kg, qualify for CrossFit Open',
      preferred_workout_time: 'evening',
      workout_days_per_week: 5,
      ...
      updated_at: '2024-12-22T18:30:00Z',
    },
    progress: 85,
  ...
  },
  {
    ...
    is_active: true,
    assigned_at: '2024-09-01T09:30:00Z',
    profile: {
      id: 111,
      user_id: 11,
      full_name: 'Ryan Patel',
      bio: 'College student, want to get stronger for sports and look better.',
      ...
      fitness_level: 'beginner' as const,
      activity_level: 'moderate' as const,
      goals: 'Build muscle, improve athleticism, bench 100kg',
      preferred_workout_time: 'evening',
      workout_days_per_week: 4,
  ...
  },
  {
    ...
    profile: {
      ...
      bio: 'Professional dancer. Need strength training for performance.',
      ...
      fitness_level: 'intermediate' as const,
      activity_level: 'very_active' as const,
      goals: 'Build core strength, prevent injuries, improve stamina',
      preferred_workout_time: 'afternoon',
      workout_days_per_week: 3,
...
// Client statistics for coach dashboard
export const mockClientStats = {
  totalClients: 12,
  activeClients: 10,
  inactiveClients: 2,
  avgProgress: 65,
  totalSessionsThisWeek: 38,
  clientsActiveToday: 8,
